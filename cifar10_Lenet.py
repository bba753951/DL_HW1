...
# one_epoch_batch=int(data_loader.num_train_data// batch_size)
loss_arr=[]
acc_arr=[]
epoch_arr=[]
for i in range(num_epochs):
    ...
    print("test accuracy: %f" % (sparse_categorical_accuracy.result()*100))
    acc_arr.append(sparse_categorical_accuracy.result()*100)
